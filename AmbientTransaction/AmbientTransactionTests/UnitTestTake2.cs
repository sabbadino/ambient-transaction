...
namespace AmbientTransactionTests
{
        ...
        public class UnitTest1Take2
    {
        ...
        [Fact]
        public async Task TestAsyncAmbientConnectionScopeTake2WithRepositoryCommitWantTransaction()
        {
            ...
            await using (var scope = AmbientConnectionScopeTake2.Create(cnString))
            {
                ...
                await r.RepoMethodWithTransaction(insert,insert2);
                scope.Complete();
            }
        ...
        [Fact]
        public async Task TestAsyncAmbientConnectionScopeTake2WithRepositoryCommit()
        {
            var cnString = "Server=THINKPAD-32;Database=transactions;User Id=sa;Password=SQL2025_;TrustServerCertificate=true";
            //await using (var scope = await XAmbientConnectionScope.CreateAsync(cnString))
            var insert = DateTime.Now.ToString("yyyy-MM-dd-hh-mm-ss--fffff");
        ...
        [Fact]
        public async Task TestAsyncAmbientConnectionScopeTake2LevelWithRepositoryCommit()
        {
            var cnString = "Server=THINKPAD-32;Database=transactions;User Id=sa;Password=SQL2025_;TrustServerCertificate=true";
            //await using (var scope = await XAmbientConnectionScope.CreateAsync(cnString))
            var insert = DateTime.Now.ToString("yyyy-MM-dd-hh-mm-ss--fffff");
        ...
        [Fact]
        public async Task TestAsyncAmbientConnectionScopeTake2WithRepositoryRollBack()
        {
            var cnString = "Server=THINKPAD-32;Database=transactions;User Id=sa;Password=SQL2025_;TrustServerCertificate=true";
            //await using (var scope = await XAmbientConnectionScope.CreateAsync(cnString))
            var insert = DateTime.Now.ToString("yyyy-MM-dd-hh-mm-ss--fffff");
            ...
            cmd2.CommandText = $"select id from table_1 where id = '{insert}'";
            var value = await cmd2.ExecuteScalarAsync();
            Assert.False(value as string == insert);


        }

        [Fact]
        public async Task TestAsyncAmbientConnectionScopeTake2Level2WithRepositoryRollBack()
        {
            var cnString = "Server=THINKPAD-32;Database=transactions;User Id=sa;Password=SQL2025_;TrustServerCertificate=true";
            //await using (var scope = await XAmbientConnectionScope.CreateAsync(cnString))
            var insert = DateTime.Now.ToString("yyyy-MM-dd-hh-mm-ss--fffff");
